...
public class Opcodes {
	...
	public static final byte NEW = 0x1A;

	// Flow
	public static final byte IF = 0x1B;
	public static final byte CALL = 0x1C;
	public static final byte GOTO = 0x1D;
	...
	public static final byte SWAP = 0x22;
	public static final byte PUSH = 0x23;
	
	// Comparison
	public static final byte EQ = 0x24;
	public static final byte GT = 0x25;
	public static final byte LT = 0x26;
	public static final byte GE = 0x27;
	public static final byte LE = 0x28;
	public static final byte IS = 0x29;
	
	// Import
	public static final byte IMPORT = 0x2A;
	public static final byte FROM_IMPORT = 0x2B;
	public static final byte FROM_IMPORT_AS = 0x2C;
