...
public enum Operator {
	...
	LSHIFT(5, LESSTHAN, LESSTHAN), RSHIFT(5, MORETHAN, MORETHAN), URSHIFT(5, MORETHAN, MORETHAN, MORETHAN),
	LESS(6, LESSTHAN), GREATER(6, MORETHAN), LESSEQUAL(6, LESSTHAN, EQUALS), MOREEQUAL(6, MORETHAN, EQUALS),
