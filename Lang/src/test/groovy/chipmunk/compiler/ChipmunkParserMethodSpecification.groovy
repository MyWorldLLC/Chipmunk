...
class ChipmunkParserMethodSpecification extends Specification {
	...
	def "parse def foo(){}"(){
		...
		then:
		node.toString() == "(method foo (param_list (var_dec self (id self))))"
	}
	...
	def "parse def foo(arg1){}"(){
		...
		then:
		node.toString() == "(method foo (param_list (var_dec self (id self)) (var_dec arg1 (id arg1))))"
	}
	...
	def "parse def foo(arg1, arg2){}"(){
		...
		then:
		node.toString() == "(method foo (param_list (var_dec self (id self)) (var_dec arg1 (id arg1)) (var_dec arg2 (id arg2))))"
	}
	...
	def "parse method def with single var body"(){
		...
		then:
		node.toString() == "(method foo (param_list (var_dec self (id self))) (var_dec asdf (id asdf) (literal 1)))"
	}
	...
	def "parse method def with multi var body"(){
		...
		then:
		node.toString() == "(method foo (param_list (var_dec self (id self))) (var_dec asdf (id asdf) (literal 1)) (var_dec asdf2 (id asdf2) (operator + (literal 1) (literal 2))))"
	}
}
