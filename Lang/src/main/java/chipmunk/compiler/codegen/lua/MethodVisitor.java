...
import chipmunk.compiler.codegen.*;
...
public class MethodVisitor implements AstVisitor {
	...
	public MethodVisitor(ModuleVisitor module){
		defaultReturn = true;
		isInner = false;
		this.module = module;
	}

	public MethodVisitor(Codegen outerCodegen, ModuleVisitor module){
